  ...
  groups: [
    {
      ...
      plans: [
        ...
        { name: "Growth", price: "৳6,000", featured: true, feats: ["কাস্টম ডিজাইন", "On-page SEO", "স্পিড অপটিমাইজেশন", "কুরিয়ার ইন্টিগ্রেশন", "ফেক অর্ডার ব্লক", "৫টি প্রোডাক্ট অ্যাড", "৭ দিনের ফ্রি সাপোর্ট"] },
        { name: "Scale", price: "৳10,000", feats: ["কমপ্লিট WooCommerce স্টোর", "কাস্টম ডিজাইন", "পেমেন্ট গেটওয়ে সেটাপ", "ইনভয়েস সেটাপ", "কুরিয়ার ইন্টিগ্রেশন", "১টি ফ্রি ল্যান্ডিং পেজ", "১৫ দিনের ফ্রি সাপোর্ট"] },
      ],
    },
    {
      label: "ভিডিও এডিটিং",
