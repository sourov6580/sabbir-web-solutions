...
export const portfolio = {
  ...
  web: [
    ...
    { t: "Intelligence Book Bangla", cat: "Landing Page", url: "https://sabbirwebportfolio.site/step/intelligence-book-bangla/", image: "/images/landing.rwmart.shop_step_intelligence-book-bangla.webp" },
    { t: "Her Wishes — Abaya", cat: "Landing Page", url: "https://herwishes.sabbirwebportfolio.site/step/shrug-type-abaya-with-beautifully-motif-work-new/", image: "/images/herwishes.rwmart.shop_step_new.webp" },
    { t: "Ai Online Mart", cat: "Landing Page", url: "https://sabbirwebportfolio.site/step/ai-online-mart/", image: "/images/ai-online-mart.webp" },
    { t: "ট্যাপ ফিল্টার", cat: "Landing Page", url: "https://sabbirwebportfolio.site/step/water-filter/", image: "/images/landing.rwmart.shop_step_water-filter.png" },
    { t: "Kid Store BD", cat: "E-commerce Website", url: "https://kidstorebd.sabbirwebportfolio.site/", image: "/images/kidstorebd.sabbirwebportfolio.site.webp" },
    { t: "Smart Work BD", cat: "E-commerce Website", url: "https://smartworkbd.sabbirwebportfolio.site/", image: "/images/smaartworkbd.com.webp" },
    { t: "New Zone BD", cat: "E-commerce Website", url: "https://newzonebd.sabbirwebportfolio.site/", image: "/images/newzonebd.rwmart.shop.png" },
    { t: "Borka Everyday", cat: "E-commerce Website", url: "https://borkaeveryday.sabbirwebportfolio.site/", image: "/images/borkaeveryday.rwmart.shop.png" },
    { t: "Her Wishes", cat: "E-commerce Website", url: "https://herwishes.sabbirwebportfolio.site/", image: "/images/herwishes.shop.webp" },
    { t: "BLACK DIAMOND", cat: "E-commerce Website", url: "https://blackdimons.sabbirwebportfolio.site/", image: "/images/blackdimons.rwmart.shop.webp" },
    { t: "City Decor & Thai", cat: "Business Website", url: "https://citydecorandthai.sabbirwebportfolio.site/", image: "/images/citydecorandthai.rwmart.shop.png" },
    { t: "আমাদের ঐতিহ্য", cat: "Other Website", url: "https://amader-proshchitra.lovable.app/", image: "/images/amader-oitijjo.png" },
  ],
  video: [
    { t: "এক চুমুকেই প্রশান্তি!", cat: "E-commerce & Product Ads", biz: "Drinks", url: "https://www.youtube.com/shorts/5SpoQSiWPCQ", vertical: true, image: "https://img.youtube.com/vi/5SpoQSiWPCQ/hqdefault.jpg" },
    { t: "Trendy Abaya set", cat: "Clothing & Fashion Ads", biz: "Clothing", url: "https://www.youtube.com/shorts/6XKwISjDni4", vertical: true, image: "https://img.youtube.com/vi/6XKwISjDni4/hqdefault.jpg" },
  ...
  groups: [
    {
      ...
      priceNote: "প্যাকেজ ফি (ডোমেইন ও হোস্টিং সহ)",
      plans: [
        { name: "Starter (ল্যান্ডিং পেজ)", oldPrice: "৳5,000", price: "৳3,500", renew: "রিনিউ ৳3,300 প্রতি বছর", feats: [".xyz ডোমেইন 1 বছর", "3 GB NVMe (cPanel) হোস্টিং 1 বছর", "প্রিমিয়াম প্লাগইন (অফিসিয়াল) 1 বছর", "মোবাইল রেসপন্সিভ ডিজাইন", "স্পিড অপ্টিমাইজেশন", "পিক্সেল সেটআপ", "ডেলিভারি টাইম 3 দিন"] },
        { name: "Growth (ল্যান্ডিং পেজ/পোর্টফোলিও ওয়েবসাইট)", oldPrice: "৳10,000", price: "৳7,500", renew: "রিনিউ ৳5,200 প্রতি বছর", featured: true, feats: [".com ডোমেইন 1 বছর", "5 GB NVMe (cPanel) হোস্টিং 1 বছর", "প্রিমিয়াম প্লাগইন (অফিসিয়াল) 1 বছর", "মোবাইল রেসপন্সিভ ডিজাইন", "স্পিড অপ্টিমাইজেশন", "পিক্সেল সেটআপ", "কুরিয়ার ইন্টিগ্রেশন", "ইনভয়েস প্রিন্ট", "ডেলিভারি টাইম 5 দিন"] },
        { name: "Scale (ইকমার্স ওয়েবসাইট)", oldPrice: "৳15,000", price: "৳13,500", renew: "রিনিউ ৳8,200 প্রতি বছর", feats: [".com ডোমেইন 1 বছর", "10 GB NVMe (cPanel) হোস্টিং 1 বছর", "প্রিমিয়াম প্লাগইন (অফিসিয়াল) 1 বছর", "ফ্রি ল্যান্ডিং পেজ 1 টা", "কাস্টম ডিজাইন (WordPress)", "মোবাইল রেসপন্সিভ", "SEO অপ্টিমাইজড", "স্পিড অপ্টিমাইজেশন", "পিক্সেল সেটআপ", "কুরিয়ার ইন্টিগ্রেশন", "ইনভয়েস প্রিন্ট", "ফেক অর্ডার ব্লক", "ডেলিভারি টাইম 15 দিন"] },
      ],
    },
    {
      label: "ভিডিও এডিটিং",
      priceNote: "ফি",
      plans: [
        { name: "বেসিক Promotional Video", price: "৳800", feats: ["30 সেকেন্ড পর্যন্ত", "মিউজিক, ভয়েস, ক্যাপশন", "HD কোয়ালিটি", "ডেলিভারি টাইম 1 দিন"] },
        { name: "বিজনেস Advertisement", price: "৳1,500", featured: true, feats: ["60 সেকেন্ড পর্যন্ত", "মিউজিক, ভয়েস, ক্যাপশন", "প্রফেশনাল ভিডিও", "HD কোয়ালিটি", "ডেলিভারি টাইম 3 দিন"] },
        { name: "প্রফেশনাল Brand Video", price: "৳3,500", feats: ["ফুল ব্র্যান্ড স্টোরি", "ক্লিয়ার ভয়েস", "প্রফেশনাল স্ট্যান্ডার্ড", "HD কোয়ালিটি", "ডেলিভারি টাইম 7 দিন"] },
      ],
    },
  ],
