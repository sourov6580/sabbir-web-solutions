  ...
  groups: [
    {
      ...
      plans: [
        { name: "Starter (ল্যান্ডিং পেজ)", price: "৳3,500", feats: ["ফ্রি ডোমেইন (.shop, .site, .xyz)", "5GB Nvme হোস্টিং (Montyly Pack)", "conversion-focused কাস্টম ডিজাইন", "মোবাইল রেসপন্সিভ", "কুরিয়ার ইন্টিগ্রেশন", "স্পিড অপটিমাইজেশন", "প্রিমিয়াম প্লাগইন (GPL)", "3 দিনে ডেলিভারি", "7 দিনের ফ্রি সাপোর্ট"] },
        { name: "Growth (ওয়েবসাইট)", price: "৳9,500", featured: true, feats: ["ফ্রি ডোমেইন (.shop, .site, .xyz)", "15GB Nvme হোস্টিং (Montyly Pack)", "কাস্টম ডিজাইন", "মোবাইল রেসপন্সিভ", "SEO অপটিমাইজ", "কুরিয়ার ইন্টিগ্রেশন", "স্পিড অপটিমাইজেশন", "ফেক অর্ডার ব্লক", "প্রিমিয়াম প্লাগইন (Official)", "15 দিনের ফ্রি সাপোর্ট"] },
        { name: "Scale", price: "৳15,500", feats: ["ফ্রি ডোমেইন (.com)", "20GB Nvme হোস্টিং (Montyly Pack)", "কাস্টম ডিজাইন", "মোবাইল রেসপন্সিভ", "SEO অপটিমাইজ", "কুরিয়ার ইন্টিগ্রেশন", "স্পিড অপটিমাইজেশন", "ফেক অর্ডার ব্লক", "invoice প্রিন্ট ফিচার", "প্রিমিয়াম প্লাগইন (Official)", "30 দিনের ফ্রি সাপোর্ট"] },
      ],
    },
    {
      label: "ভিডিও এডিটিং",
      ...
      plans: [
        ...
        { name: "বিজনেস Advertisement", price: "৳1,500", featured: true, feats: ["60 সেকেন্ড পর্যন্ত", "প্রফেশনাল ভিডিও", "2 রিভিশন", "Ad-ready ফরম্যাট", "ডেলিভারি টাইম 3 দিন"] },
