  ...
  groups: [
    {
      ...
      plans: [
        ...
        { name: "Scale", price: "৳10,000", feats: ["কমপ্লিট WooCommerce স্টোর", "কাস্টম ডিজাইন", "পেমেন্ট গেটওয়ে সেটাপ", "ইনভয়েস সেটাপ", "১০টি প্রোডাক্ট অ্যাড", "১টি ফ্রি ল্যান্ডিং পেজ", "১৫ দিনের ফ্রি সাপোর্ট"] },
      ],
    },
    {
      label: "ভিডিও এডিটিং",
